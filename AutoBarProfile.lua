...
function AutoBarProfile.InitializeClass()
	...
	AutoBarProfile.ROGUE[20] = { "POISON-DISSOLVENT","POISON-INSTANT","POISON-CRIPPLING","POISON-MINDNUMBING" };
	AutoBarProfile.ROGUE[21] = { "POISON-CORROSIVE", "POISON-DEADLY", "POISON-WOUND" };
