...
local INSTANTPOISON = 20;
local STACKPOISON = 21;
local PETFOOD = 24;
...
function AutoBarProfile.InitializeBasic()
	...
	AutoBarProfile.basic[4] = { "HEALPOTIONS", "REJUVENATION_POTIONS", "WHIPPER_ROOT", "NIGHT_DRAGONS_BREATH", "PVP_HEALPOTIONS", "ALTERAC_HEAL","TEAS", "HEALTHSTONE" };
...
function AutoBarProfile.InitializeClass()
	...
	AutoBarProfile.ROGUE[INSTANTPOISON] = { "POISON-DISSOLVENT", "POISON-INSTANT", "POISON-CRIPPLING", "POISON-MINDNUMBING" };
    AutoBarProfile.ROGUE[STACKPOISON] = {  "POISON-WOUND","POISON-DEADLY","POISON-CORROSIVE"};
	AutoBarProfile.ROGUE[BUFFSLOT] = { "POTION_FORTITUDE","POTION_AGILITY","GROUND_SCORPOK_ASSAY","FLASK_OF_THE_TITANS","POTION_STRENGTH","SCROLL_AGILITY", "SCROLL_PROTECTION", "SCROLL_SPIRIT", "SCROLL_STAMINA", "SCROLL_STRENGTH", "BUFF_ATTACKPOWER", "BUFF_DODGE", "BUFF_FROST", "BUFF_FIRE", "SCROLL_INTELLECT", "POTION_SPELLPOWER" };
	AutoBarProfile.ROGUE[BUFFSLOT2] = { "BUFF_ATTACKSPEED", "POTION_QUICKNESS" };
