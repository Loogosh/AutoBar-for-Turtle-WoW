...
function AutoBarProfile.InitializeClass()
	...
	AutoBarProfile.ROGUE[BUFFSLOT] = { "POTION_FORTITUDE","POTION_AGILITY","GROUND_SCORPOK_ASSAY","POTION_STRENGTH","SCROLL_AGILITY", "SCROLL_PROTECTION", "SCROLL_SPIRIT", "SCROLL_STAMINA", "SCROLL_STRENGTH", "BUFF_ATTACKPOWER", "BUFF_DODGE", "BUFF_FROST", "BUFF_FIRE", "SCROLL_INTELLECT", "POTION_SPELLPOWER" };
