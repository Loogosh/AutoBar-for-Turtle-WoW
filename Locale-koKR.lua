...
AUTOBAR_CLASS_GROUND_SCORPOK_ASSAY = "갈아진 스코르폭 분석물";
AUTOBAR_CLASS_POTION_QUICKNESS = "신속의 물약";
AUTOBAR_CLASS_POISON_CRIPPLING = "신경 마비 독";
AUTOBAR_CLASS_POISON_DEADLY = "맹독";
AUTOBAR_CLASS_POISON_INSTANT_ALL = "순간 효과 독";
AUTOBAR_CLASS_POISON_MINDNUMBING = "정신 마비 독";
AUTOBAR_CLASS_POISON_WOUND = "상처 감염 독";
AUTOBAR_CLASS_POISON_DISSOLVENT = "용해 독";
AUTOBAR_CLASS_POISON_DISSOLVENT_II = "용해 독 II";
