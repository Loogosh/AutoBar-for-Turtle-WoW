...
AUTOBAR_CLASS_GROUND_SCORPOK_ASSAY = "研磨蝎毒分析物";
AUTOBAR_CLASS_POTION_QUICKNESS = "迅捷药水";
AUTOBAR_CLASS_POISON_INSTANT_ALL = "速效毒药";
...
AUTOBAR_CLASS_POISON_DISSOLVENT = "溶解毒药";
AUTOBAR_CLASS_POISON_DISSOLVENT_II = "溶解毒药 II";
