...
AUTOBAR_CLASS_GROUND_SCORPOK_ASSAY = "研磨蠍毒分析物";
AUTOBAR_CLASS_POTION_QUICKNESS = "迅捷藥水";
AUTOBAR_CLASS_POISON_CRIPPLING = "致殘毒藥";
AUTOBAR_CLASS_POISON_DEADLY = "致命毒藥";
AUTOBAR_CLASS_POISON_INSTANT_ALL = "速效毒藥";
AUTOBAR_CLASS_POISON_MINDNUMBING = "麻痹毒藥";
AUTOBAR_CLASS_POISON_WOUND = "致傷毒藥";
AUTOBAR_CLASS_POISON_DISSOLVENT = "溶解毒藥";
AUTOBAR_CLASS_POISON_DISSOLVENT_II = "溶解毒藥 II";
