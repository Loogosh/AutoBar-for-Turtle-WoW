...
AUTOBAR_CLASS_SPELLPOWERPOTIONS = "Spellpower Potions";
...
AUTOBAR_CLASS_DRINK_STAMINA = "Drink: Stamina Bonus";
...
AUTOBAR_CLASS_POISON_CORROSIVE = "Corrosive Poison";
AUTOBAR_CLASS_POISON_DISSOLVENT = "Dissolvent Poison";
AUTOBAR_CLASS_POISON_DISSOLVENT_II = "Dissolvent Poison II";
...
AUTOBAR_CLASS_QUESTSTARTITEMS = "Items that Start Quests"
AUTOBAR_CLASS_QUESTUSEITEMS = "Items Used During Quests"
